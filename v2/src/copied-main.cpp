...
// This is mostly the rs2-pose-apriltag example from
...
Eigen::Vector3d reletiveTranslation(rs2_pose camera_pose, Eigen::Vector3d target){
}
...
int main(int argc, char * argv[]) try
{
    ...
    while (true)
    {
        ...
        if(frame_number % 6 == 0)
        {
            std::cout << "pose: x: " << camera_pose.translation.x << "\ty: " << camera_pose.translation.y << "\tz: " << camera_pose.translation.z << "\n";
            fisheye_frame.keep();
